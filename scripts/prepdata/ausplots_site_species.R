# using ausplotsR package access species-in-site data from AusPlots, calculate
# percent covers for species-in-sites, then taxonomic name matching using Australian
# Plant Census apcnames tool
...
ausplots_site_species <- cache_csv("data_cache/ausplots_site_species.csv", function() {
  ...
  # align patched names to the Australian Plant Census and Australian Plant Name Index
